...
class salariedEmployee : public Employee
{
    ...
    void show()
    {
        ...
        cout << "earned: $" << (bonus(birthdate.getMonth())?salary+100:salary) << endl << endl;
    }
...
class hourlyemployee : public Employee
{
    ...
    void show()
    {
        ...
        cout <<  (bonus(birthdate.getMonth())?"HAPPY BIRTHDAY!\n":"");
        cout << "earned: $" << (bonus(birthdate.getMonth())?hour*wage+100:hour*wage) << endl << endl;
    }
...
class commissionemployee : public Employee
{
    ...
    void show()
    {
        ...
        cout <<  (bonus(birthdate.getMonth())?"HAPPY BIRTHDAY!\n":"");
        cout << "earned: $" << (bonus(birthdate.getMonth())?sale*commission+100:sale*commission) << endl << endl;
    }
...
class basecommissionemployee : public Employee
{
    ...
    void show()
    {
        ...
        cout <<  (bonus(birthdate.getMonth())?"HAPPY BIRTHDAY!\n":"");
        cout << "earned: $" << (bonus(birthdate.getMonth())?sale*commission+base+100:sale*commission+base) << endl << endl;
    }
...
{
    // Date a(1944,15,6);
    // salariedEmployee k("John Smith","111-11-1111",a,800);
    // k.show();
    // Date b(1960,5,29);
    // hourlyemployee j("Karen Price","222-22-2222",b,16.75,40);
    // j.show();
    // Date c(1954,9,8);
    // commissionemployee i("Sue Jones","333-33-3333",c,10000,0.06);
    // i.show();
    // Date d(1965,3,2);
    // basecommissionemployee n("Bob Lewis","444-44-4444",d,5000,0.04,300);
    // n.show();
